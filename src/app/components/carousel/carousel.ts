import { AfterContentInit, ChangeDetectionStrategy, Component, ContentChildren, Input, input, OnInit, QueryList } from '@angular/core';
...
export class Carousel extends CdkStepper implements OnInit, AfterContentInit {
